...
def main():
    ...
    searches = [
        ...
        ('INBOX', 'SUBJECT "REDACTED_CLAIM"', "claim ID"),
        # By pre-auth ID in subject
        ('INBOX', 'SUBJECT "REDACTED_CLAIM"', "pre-auth ID"),
        # By policy number in subject
        ('INBOX', 'SUBJECT "REDACTED_POLICY"', "policy number"),
        ...
        ('INBOX', 'FROM "policybazaar" SUBJECT "REDACTED_POLICY"', "policybazaar+policy"),
    ...
    sent_searches = [
        ('Sent', 'SUBJECT "REDACTED_POLICY"', "sent+policy"),
        ('Sent', 'SUBJECT "REDACTED_CLAIM"', "sent+claim"),
        ('Sent', 'SUBJECT "REDACTED_CLAIM"', "sent+preauth"),
    ...
    for r in sorted(all_received.values(), key=lambda x: x["date"]):
        ...
        if is_policybazaar:
            has_policy_num = "REDACTED_POLICY" in r["subject"]
